...
## Bluetoothの接続を完全にやり直す場合

通常のペアリング解除で改善しない場合は、Bluetooth専用リセットファームを使用してください。
左右両方のBluetooth結合情報を消去してから、通常ファームを書き戻す必要があります。

詳しい手順と専用UF2については、[Bluetooth完全リセット手順](docs/bluetooth-factory-reset.md)を参照してください。
